PROXY_URL = 'http://192.168.0.111:1087/'
...
Vagrant.configure('2') do |config|
    ...
    config.vm.provision :shell, privileged: true, path: './init_common.sh'
    ...
    # config.vm.network :public_network, ip: '192.168.0.89', bridge: 'en7: USB 10/100/1000 LAN'
    config.vm.network :private_network, ip: '192.168.100.10'
    config.vm.provision :shell, privileged: false, path: './init_user.sh'
end
